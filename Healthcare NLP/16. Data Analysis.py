...
# MAGIC 
# MAGIC In the previous notebook (`./15-entity-extraction`) we used SparkNLP's pipelines to extract hightly specialized oncological entities from unstructured notes and stored the resulting tabular data in our delta lake.
# MAGIC 
