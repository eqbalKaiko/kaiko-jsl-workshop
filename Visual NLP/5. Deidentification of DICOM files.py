...
# MAGIC %md
# MAGIC ##De-identification Dicom in Spark OCR
...
# MAGIC %md
# MAGIC ###1 Define Spark NLP de-identification pipeline
...
# MAGIC %md
# MAGIC ###2 Define Spark OCR pipeline
...
# MAGIC %md
# MAGIC ####Display coordinates of text which need to hide
...
# MAGIC %md
# MAGIC ###4 Display original and de-identified results
